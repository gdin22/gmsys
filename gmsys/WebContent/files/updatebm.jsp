...
<%--内容 --%>
        <div class="tpl-content-wrapper">
            <form action="${pageContext.request.contextPath}/department/update.do" method="post"  name="form"  >
				<div class="MainDiv">
				<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
				  <tr>
				      <th class="tablestyle_title" >部门基本信息修改</th>
				  </tr>
				  <tr>
				    <td class="CPanel">
							...
							<TD width="100%">
								...
								<legend>部门信息</legend>
									  ...
									  <td nowrap align="right" width="15%">部门编号:</td>
									    <td width="35%"><input name='departid' type="text" class="text" style="width:154px" value="<%=department.getDepartid() %>" />
								        <span class="red">*</span></td>
									    <td nowrap align="right" width="15%">部门名称:</td>
									    <td width="35%"><input name='departname' type="text" class="text" style="width:154px" value="<%=department.getDepartname() %>" />
									      <td nowrap align="right" width="15%">所属区域:</td>
									    <td width="35%">
											<select name="areaname" >
											    <option  selected="selected">==请选择==</option>
											  	<option selected="selected"><%=department.getAreaname() %></option>
											    <option>华南区</option>
											    <option>华西区</option>
											    <option>华北区</option>
											    <option>华东区</option>
