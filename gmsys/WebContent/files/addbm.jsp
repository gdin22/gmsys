...
<%--内容 --%>
        <div class="tpl-content-wrapper">
             <form action="${pageContext.request.contextPath}/department/add.do" method="post"  name="form"  >
				<div class="MainDiv">
							...
							<TD width="100%">
								...
								<legend>部门信息</legend>
									  ...
									  <tr>
									    ...
									    <td width="35%"><input name='departname' type="tetx" class="text" style="width:154px" value="" />
