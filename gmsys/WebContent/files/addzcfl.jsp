...
<%--内容 --%>
        <div class="tpl-content-wrapper">
            <form action="${pageContext.request.contextPath}/category/add.do" method="post"  name="form"  >
				<div class="MainDiv">
				<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
				  <tr>
				      <th class="tablestyle_title" >资产分类信息录入</th>
				  </tr>
				  <tr>
				    <td class="CPanel">
							...
							<TD width="100%">
								...
								<legend>分类信息</legend>
									  ...
									  <tr>
									    ...
									    <td width="35%"><input name='cname' type="text" class="text" style="width:154px" value="" />
